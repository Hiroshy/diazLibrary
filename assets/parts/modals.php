          ...
          <div class="container-fluid px-xl-0">
            <div class="row align-items-center mx-xl-0">
              <div class="col-12 col-lg-6 col-xl-5 py-4 py-xl-0 px-xl-0">
                ...
                <!-- Button -->
                <a class="btn btn-sm btn-block btn-primary" href="product">
          ...
          <div class="modal-body border-top font-size-sm">
            ...
            <div class="row align-items-center position-relative mb-5">
              ...
              <div class="col position-static">
                ...
                <p class="mb-0 font-weight-bold">
                  <a class="stretched-link text-body" href="product">Vestimenta judia</a> <br>
                  <span class="text-muted">1.5 horas</span>
                </p>
            ...
            <div class="row align-items-center position-relative mb-5">
              ...
              <div class="col position-static">
                ...
                <!-- Text -->
                <p class="mb-0 font-weight-bold">
                  <a class="stretched-link text-body" href="product">Cotton floral print Dress</a> <br>
            ...
            <div class="row align-items-center position-relative mb-5">
              ...
              <div class="col position-static">
                ...
                <!-- Text -->
                <p class="mb-0 font-weight-bold">
                  <a class="stretched-link text-body" href="product">Leather Sneakers</a> <br>
            ...
            <div class="row align-items-center position-relative mb-5">
              ...
              <div class="col position-static">
                ...
                <!-- Text -->
                <p class="mb-0 font-weight-bold">
                  <a class="stretched-link text-body" href="product">Cropped cotton Top</a> <br>
            ...
            <div class="row align-items-center position-relative mb-5">
              ...
              <div class="col position-static">
                ...
                <!-- Text -->
                <p class="mb-0 font-weight-bold">
                  <a class="stretched-link text-body" href="product">Floral print midi Dress</a> <br>
            ...
            <!-- Button -->
            <a class="btn btn-link px-0 text-reset" href="shop">
    ...
    <div class="modal fixed-right fade" id="modalShoppingCart" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-dialog-vertical" role="document">
        ...
        <div class="modal-content">
          ...
          <!-- Header-->
          <div class="modal-header line-height-fixed font-size-lg">
            <strong class="mx-auto">Ver más tarde (2)</strong>
          </div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-8">
                  ...
                  <p class="font-size-sm font-weight-bold mb-6">
                    <a class="text-body" href="product">Cotton floral print Dress</a> <br>
                    <span class="text-muted">$40.00</span>
                  </p>
            ...
            <li class="list-group-item">
              <div class="row align-items-center">
                ...
                <div class="col-8">
                  ...
                  <!-- Title -->
                  <p class="font-size-sm font-weight-bold mb-6">
                    <a class="text-body" href="product">Suede cross body Bag</a> <br>
          ...
          <!-- Buttons -->
          <div class="modal-body">
            <a class="btn btn-block btn-dark" href="checkout">Reproducir</a>
            <a class="btn btn-block btn-outline-dark" href="shopping-cart">Ver favoritos</a>
          </div>
        ...
        <div class="modal-content">
            ...
            <ul class="nav nav-vertical nav-unstyled font-size-h2" id="sidebarNav">
                ...
                <div class="collapse" id="sidebarHome" data-parent="#sidebarNav">
                  <ul class="list-styled font-size-lg py-3 mb-0">
                    <li class="list-styled-item">
                      <a class="list-styled-link" href="index-2">Default</a>
                    </li>
                    <li class="list-styled-item">
                      <a class="list-styled-link" href="index-classic">Classic</a>
                    </li>
                    <li class="list-styled-item">
                      <a class="list-styled-link" href="index-fashion">Fashion</a>
                    </li>
                    <li class="list-styled-item">
                      <a class="list-styled-link" href="index-boxed">Boxed</a>
                    </li>
                    <li class="list-styled-item">
                      <a class="list-styled-link" href="index-simple">Simple</a>
                    </li>
                    <li class="list-styled-item">
                      <a class="list-styled-link" href="index-asymmetric">Asymmetric</a>
                    </li>
                    <li class="list-styled-item">
                      <a class="list-styled-link" href="index-sidenav">Sidenav</a>
                    </li>
                    <li class="list-styled-item">
                      <a class="list-styled-link" href="index-landing">Landing</a>
                    </li>
                  </ul>
                </div>
                  ...
                  <div class="row">
                    <div class="col-12 py-3">
                      ...
                      <ul class="list-styled font-size-lg py-3">
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">All Clothing</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Blouses & Shirts</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Coats & Jackets</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Dresses</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Hoodies & Sweats</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Denim</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Jeans</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Jumpers & Cardigans</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Leggings</a>
                        </li>
                      </ul>
                    ...
                    <div class="col-12 py-3">
                      ...
                      <ul class="list-styled font-size-lg">
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">All Shoes & Boots</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Branded Shoes</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Boots</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Heels</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Trainers</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Sandals</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Shoes</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Wide Fit Shoes</a>
                        </li>
                      </ul>
                    ...
                    <div class="col-12 py-3">
                      ...
                      <ul class="list-styled font-size-lg">
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">All Bags & Accessories</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Accessories</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Bags & Purses</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Luggage</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Belts</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Hats</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Hair Accessories</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Jewellery</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Travel Accessories</a>
                        </li>
                      </ul>
                ...
                <div class="collapse" id="sidebarShop" data-parent="#sidebarNav">
                  <div class="row">
                    <div class="col-12 py-3">
                      ...
                      <ul class="list-styled font-size-lg">
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop">Default</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop-topbar">Topbar</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop-collapse">Collapse</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop-simple">Simple</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shop-masonry">Masonry</a>
                        </li>
                      </ul>
                    ...
                    <div class="col-12 py-3">
                      ...
                      <ul class="list-styled font-size-lg">
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="product">Default</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="product-images-left">Images Left</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="product-image-grid">Image Grid</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="product-image-slider">Image Slider</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="product-images-stacked">Images Stacked</a>
                        </li>
                      </ul>
                    ...
                    <div class="col-12 py-3">
                      ...
                      <ul class="list-styled font-size-lg">
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shopping-cart">Shopping Cart</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="checkout">Checkout</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="order-completed">Order Completed</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="shipping-and-returns">Shipping & Returns</a>
                        </li>
                      </ul>
                    ...
                    <div class="col-12 py-3">
                      ...
                      <ul class="list-styled font-size-lg">
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="account-order">Order</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="account-orders">Orders</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="account-wishlist">Wishlist</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="account-personal-info">Personal Info</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="account-address">Addresses</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="account-address-edit">Addresses: New</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="account-payment">Payment</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="account-payment-edit">Payment: New</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="account-payment-choose">Payment: Choose</a>
                        </li>
                        <li class="list-styled-item">
                          <a class="list-styled-link" href="auth">Auth</a>
                        </li>
                      </ul>
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="sidebarPages" data-parent="#sidebarNav">
                  <ul class="list-styled font-size-lg py-3 mb-0">
                    ...
                    <li class="list-styled-item">
                      <a class="list-styled-link" href="store-locator">Store Locator</a>
                    </li>
                    <li class="list-styled-item">
                    ...
                    <li class="list-styled-item">
                      <a class="list-styled-link" href="404">404</a>
                    </li>
                  </ul>
                </div>
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="sidebarBlog" data-parent="#sidebarNav">
                  <ul class="list-styled font-size-lg py-3 mb-0">
                    <li class="list-styled-item">
                      <a class="list-styled-link" href="blog">Blog</a>
                    </li>
                    <li class="list-styled-item">
                      <a class="list-styled-link" href="blog-post">Blog Post</a>
                    </li>
                  </ul>
                </div>
          ...
          <div class="moda-body px-10 py-9">
            ...
            <div class="font-size-xxs text-gray-350">
              © <span id="year"></span> All rights reserved. Designed by Unvab.
            </div>
          ...
          <div class="modal-body">
            <div class="row mb-6">
              ...
              <div class="col-12 col-md-9">
                ...
                <!-- Label -->
                <p>
                  <a class="font-weight-bold text-body" href="product">Cotton floral print Dress</a>
                </p>
