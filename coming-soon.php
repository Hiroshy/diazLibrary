...
<!-- Mirrored from yevgenysim.github.io/shopper/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Jan 2021 07:30:09 GMT -->
...
<head>
  ...
  <body>
    ...
    <!-- NAVBAR -->
    <nav class="navbar navbar-expand navbar-dark @@classList">
      <div class="container">
    ...
    <!-- CONTENT -->
    <section class="bg-cover" style="margin-top: -90px; background-image: url(assets/img/covers/cover-22.jpg);">
              ...
              <div class="form-row">
                <div class="col-12 col-md">
                  ...
                  <div class="form-group mb-md-0">
                    ...
                    <input class="form-control form-control-dark" id="comingSoonEmail" type="email" placeholder="Enter Email *">
                  </div>
