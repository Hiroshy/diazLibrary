...
<!-- Mirrored from yevgenysim.github.io/shopper/product-images-stacked.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Jan 2021 07:30:01 GMT -->
          ...
          <div class="col-12">
            <div class="row">
              <div class="col-12 col-md-6">
                ...
                <!-- Image -->
                <a class="d-block mb-4" href="assets/img/products/product-157.jpg" data-fancybox>
                  <img class="img-fluid" src="assets/img/products/product-157.jpg" alt="...">
                </a>

                <!-- Image -->
                <a class="d-block mb-4" href="assets/img/products/product-158.jpg" data-fancybox>
                  <img class="img-fluid" src="assets/img/products/product-158.jpg" alt="...">
                </a>

                <!-- Image -->
                <a class="d-block" href="assets/img/products/product-159.jpg" data-fancybox>
                  <img class="img-fluid" src="assets/img/products/product-159.jpg" alt="...">
                </a>
              ...
              <div class="col-12 col-md-6 pl-lg-10">
                <div class="position-sticky" style="top: 62px;">
                  ...
                  <!-- Heading -->
                  <h3 class="mb-2">Printed T-Shirt</h3>

                  <!-- Price -->
                  <div class="mb-7">
                    <span class="ml-1 font-size-h5 font-weight-bolder">$11.00</span>
                  ...
                  <form class="mb-9">
                    <div class="form-group">
                      ...
                      <!-- Label -->
                      <p class="mb-5">
                        Color: <strong id="colorCaption">Pink</strong>
                      </p>

                      <!-- Radio -->
                      <div class="mb-8 ml-n1">
                        <div class="custom-control custom-control-inline custom-control-img">
                          <input type="radio" class="custom-control-input" id="imgRadioOne" name="imgRadio" data-toggle="form-caption" data-target="#colorCaption" value="Pink" checked>
                          <label class="custom-control-label" for="imgRadioOne">
                            <span class="embed-responsive embed-responsive-1by1 bg-cover" style="background-image: url(assets/img/products/product-157.jpg);"></span>
                          </label>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <!-- Label -->
                      <p class="mb-5">
                        Size: <strong><span id="sizeCaption">S</span></strong>
                      </p>

                      <!-- Radio -->
                      <div class="mb-2">
                        <div class="custom-control custom-control-inline custom-control-size mb-2">
                          <input type="radio" class="custom-control-input" name="sizeRadio" id="sizeRadioOne" value="3XS" data-toggle="form-caption" data-target="#sizeCaption">
                          <label class="custom-control-label" for="sizeRadioOne">3XS</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-control-size mb-2">
                          <input type="radio" class="custom-control-input" name="sizeRadio" id="sizeRadioTwo" value="2XS" data-toggle="form-caption" data-target="#sizeCaption" disabled>
                          <label class="custom-control-label" for="sizeRadioTwo">2XS</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-control-size mb-2">
                          <input type="radio" class="custom-control-input" name="sizeRadio" id="sizeRadioThree" value="XS" data-toggle="form-caption" data-target="#sizeCaption">
                          <label class="custom-control-label" for="sizeRadioThree">XS</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-control-size mb-2">
                          <input type="radio" class="custom-control-input" name="sizeRadio" id="sizeRadioFour" value="S" data-toggle="form-caption" data-target="#sizeCaption" checked>
                          <label class="custom-control-label" for="sizeRadioFour">S</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-control-size mb-2">
                          <input type="radio" class="custom-control-input" name="sizeRadio" id="sizeRadioFive" value="M" data-toggle="form-caption" data-target="#sizeCaption">
                          <label class="custom-control-label" for="sizeRadioFive">M</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-control-size mb-2">
                          <input type="radio" class="custom-control-input" name="sizeRadio" id="sizeRadioSix" value="L" data-toggle="form-caption" data-target="#sizeCaption">
                          <label class="custom-control-label" for="sizeRadioSix">L</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-control-size mb-2">
                          <input type="radio" class="custom-control-input" name="sizeRadio" id="sizeRadioSeven" value="XL" data-toggle="form-caption" data-target="#sizeCaption" disabled>
                          <label class="custom-control-label" for="sizeRadioSeven">XL</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-control-size mb-2">
                          <input type="radio" class="custom-control-input" name="sizeRadio" id="sizeRadioEight" value="2XL" data-toggle="form-caption" data-target="#sizeCaption" disabled>
                          <label class="custom-control-label" for="sizeRadioEight">2XL</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-control-size mb-2">
                          <input type="radio" class="custom-control-input" name="sizeRadio" id="sizeRadioNine" value="3XL" data-toggle="form-caption" data-target="#sizeCaption">
                          <label class="custom-control-label" for="sizeRadioNine">3XL</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-control-size mb-2">
                          <input type="radio" class="custom-control-input" name="sizeRadio" id="sizeRadioTen" value="4XL" data-toggle="form-caption" data-target="#sizeCaption">
                  ...
                  <div class="list-group list-group-sm list-group-flush-x" id="productCollapseParent">
                      ...
                      <div class="collapse" id="productCollapseDetails" data-parent="#productCollapseParent">
                        <div class="pt-5 font-size-sm text-gray-500">
                          ...
                          <ul class="list-unstyled mb-0">
                            <li>
                              <strong class="text-body">SKU:</strong class="text-body"> #61590437
                            </li>
                            <li>
                              <strong class="text-body">Country:</strong> Italy
                            </li>
                            <li>
                              <strong class="text-body">Materials:</strong> Cotton 90%, Elastane 10%
                            </li>
                            <li>
                    ...
                    <div class="list-group-item">
                      ...
                      <!-- Collapse -->
                      <div class="collapse" id="productCollapseSize" data-parent="#productCollapseParent">
                    ...
                    <div class="list-group-item">
                      ...
                      <!-- Collapse -->
                      <div class="collapse" id="productCollapseShipping" data-parent="#productCollapseParent">
                        <div class="pt-5 font-size-sm text-gray-500">
...
<!-- Mirrored from yevgenysim.github.io/shopper/product-images-stacked.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Jan 2021 07:30:02 GMT -->
</html>
