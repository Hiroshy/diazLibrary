...
<!-- Mirrored from yevgenysim.github.io/shopper/overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Jan 2021 07:30:30 GMT -->
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-xl navbar-light @@classList">
      <div class="container">
        ...
        <!-- Toggler -->
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarDocsTopCollapse" aria-controls="navbarDocsTopCollapse" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarDocsTopCollapse">
          ...
          <!-- Button -->
          <a class="btn btn-block btn-sm btn-dark w-xl-auto mt-2 my-xl-n2" href="https://themes.getbootstrap.com/product/shopper/" target="_blank">Buy Now for $49</a>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-5 col-lg-6 col-xl-7 order-md-2">
            ...
            <!-- Image -->
            <img class="img-fluid minw-md-200 minw-lg-125 mb-9 mb-md-0" src="assets/img/devices/devices-1.png" alt="...">
          ...
          <div class="col-12 col-md-7 col-lg-6 col-xl-5 order-md-1">
            ...
            <!-- Button -->
            <a class="btn btn-primary" href="#pages" data-toggle="smooth-scroll">
              Find Out More
            </a>
        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-3">
            ...
            <div class="d-flex mb-6 mb-lg-0">
              ...
              <!-- Icon -->
              <i class="fe fe-home font-size-lg text-primary"></i>
          ...
          <div class="col-12 col-md-6 col-lg-3">
            ...
            <div class="d-flex mb-6 mb-md-0">
              ...
              <!-- Icon -->
              <i class="fe fe-menu font-size-lg text-primary"></i>
          ...
          <div class="col-12 col-md-6 col-lg-3">
            ...
            <div class="d-flex">
              ...
              <!-- Icon -->
              <i class="fe fe-shopping-bag font-size-lg text-primary"></i>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 col-md-4">
            ...
            <!-- Card -->
            <a class="card mb-7 bg-transparent text-body" href="index-2.html">
              ...
              <div class="card-body text-center">
                <strong class="font-size-lg">Default</strong>
              </div>
          ...
          <div class="col-12 col-md-4">
            ...
            <a class="card mb-7 bg-transparent text-body" href="index-classic.html">
              ...
              <!-- Body -->
              <div class="card-body text-center">
                <strong class="font-size-lg">Classic</strong>
              </div>
          ...
          <div class="col-12 col-md-4">
            ...
            <a class="card mb-7 bg-transparent text-body" href="index-fashion.html">
              ...
              <!-- Body -->
              <div class="card-body text-center">
                <strong class="font-size-lg">Fashion</strong>
              </div>
          ...
          <div class="col-12 col-md-4">
            ...
            <a class="card mb-7 bg-transparent text-body" href="index-boxed.html">
              ...
              <!-- Body -->
              <div class="card-body text-center">
                <strong class="font-size-lg">Boxes</strong>
              </div>
          ...
          <div class="col-12 col-md-4">
            ...
            <a class="card mb-7 bg-transparent text-body" href="index-simple.html">
              ...
              <!-- Body -->
              <div class="card-body text-center">
                <strong class="font-size-lg">Simple</strong>
              </div>
          ...
          <div class="col-12 col-md-4">
            ...
            <a class="card mb-7 bg-transparent text-body" href="index-asymmetric.html">
              ...
              <!-- Body -->
              <div class="card-body text-center">
                <strong class="font-size-lg">Asymmetric</strong>
              </div>
          ...
          <div class="col-12 col-md-4">
            ...
            <a class="card mb-7 mb-md-0 bg-transparent text-body" href="index-sidenav.html">
              ...
              <!-- Body -->
              <div class="card-body text-center">
                <strong class="font-size-lg">Sidenav</strong>
              </div>
          ...
          <div class="col-12 col-md-4">
            ...
            <a class="card mb-7 mb-md-0 bg-transparent text-body" href="index-landing.html">
              ...
              <!-- Body -->
              <div class="card-body text-center">
                <strong class="font-size-lg">Landing</strong>
              </div>
            ...
            <div class="flickity-buttons-lg flickity-light px-lg-12" data-flickity='{"prevNextButtons": true}'>
              <div class="col-12 col-md-4 col-lg-3 pt-1">
                ...
                <a class="card card-sm bg-transparent text-white" href="about.html">
                  ...
                  <!-- Body -->
                  <div class="card-body text-center">
                    <strong class="font-size-lg">About</strong>
                  </div>
              ...
              <div class="col-12 col-md-4 col-lg-3 pt-1">
                ...
                <a class="card card-sm bg-transparent text-white" href="contact-us.html">
                  ...
                  <!-- Body -->
                  <div class="card-body text-center">
                    <strong class="font-size-lg">Contact Us</strong>
                  </div>
              ...
              <div class="col-12 col-md-4 col-lg-3 pt-1">
                ...
                <a class="card card-sm bg-transparent text-white" href="store-locator.html">
                  ...
                  <!-- Body -->
                  <div class="card-body text-center">
                    <strong class="font-size-lg">Store Locator</strong>
                  </div>
              ...
              <div class="col-12 col-md-4 col-lg-3 pt-1">
                ...
                <a class="card card-sm bg-transparent text-white" href="faq.html">
                  ...
                  <!-- Body -->
                  <div class="card-body text-center">
                    <strong class="font-size-lg">FAQ</strong>
                  </div>
              ...
              <div class="col-12 col-md-4 col-lg-3 pt-1">
                ...
                <a class="card card-sm bg-transparent text-white" href="coming-soon.html">
                  ...
                  <!-- Body -->
                  <div class="card-body text-center">
                    <strong class="font-size-lg">Coming Soon</strong>
                  </div>
              ...
              <div class="col-12 col-md-4 col-lg-3 pt-1">
                ...
                <a class="card card-sm bg-transparent text-white" href="404.html">
                  ...
                  <!-- Body -->
                  <div class="card-body text-center">
                    <strong class="font-size-lg">Not Found</strong>
                  </div>
                        ...
                        <form>
                          <div class="mb-1">
                            <div class="custom-control custom-control-inline custom-control-color">
                              ...
                              <label class="custom-control-label" style="color: black;" for="productEightColorOne"></label>
                            </div>
                            <div class="custom-control custom-control-inline custom-control-color ml-n2">
                              ...
                              <label class="custom-control-label" data-slide="1" style="color: red;" for="productEightColorTwo"></label>
                            </div>
                          </div>
                          <div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-8 col-lg-6 col-xl-4 py-14">
            ...
            <!-- Text -->
            <p class="font-size-lg text-gray-500 mb-0">
          ...
          <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="card card-sm mb-7 border">
              <div class="card-body d-flex align-items-center">
                ...
                <!-- Image -->
                <img class="mr-4" src="assets/img/icons/brands/bootstrap.svg" alt="...">
          ...
          <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="card card-sm mb-7 border">
              <div class="card-body d-flex align-items-center">
                ...
                <!-- Image -->
                <img class="mr-4" src="assets/img/icons/brands/figma.svg" alt="...">
          ...
          <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="card card-sm mb-7 mb-lg-0 border">
              <div class="card-body d-flex align-items-center">
                ...
                <!-- Image -->
                <img class="mr-4" src="assets/img/icons/brands/sass.svg" alt="...">
          ...
          <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="card card-sm mb-7 mb-lg-0 border">
              <div class="card-body d-flex align-items-center">
                ...
                <!-- Image -->
                <img class="mr-4" src="assets/img/icons/brands/gulp.svg" alt="...">
          ...
          <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="card card-sm mb-7 mb-md-0 border">
              <div class="card-body d-flex align-items-center">
                ...
                <!-- Image -->
                <img class="mr-4" src="assets/img/icons/brands/w3c.svg" alt="...">
          ...
          <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="card card-sm border">
              <div class="card-body d-flex align-items-center">
                ...
                <!-- Image -->
                <img class="mr-4" src="assets/img/icons/brands/doc.svg" alt="...">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-8 text-center">
              ...
              <!-- Buttons -->
              <a class="btn btn-primary" href="https://themes.getbootstrap.com/product/shopper/" href="_blank.html">
                Buy Now for $49
              </a>
...
<!-- Mirrored from yevgenysim.github.io/shopper/overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Jan 2021 07:30:43 GMT -->
</html>
