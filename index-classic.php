...
<!-- Mirrored from yevgenysim.github.io/shopper/index-classic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Jan 2021 07:28:46 GMT -->
    ...
    <nav class="navbar navbar-expand-xl navbar-light @@classList">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarClassicCollapse">
                    ...
                    <div class="container">
                      <div class="row">
                        <div class="col-4 col-md">
                          ...
                          <!-- Heading -->
                          <div class="mb-5 font-weight-bold">Women</div>
                        ...
                        <div class="col-4 col-md">
                          ...
                          <!-- Heading -->
                          <div class="mb-5 font-weight-bold">Men</div>
                        ...
                        <div class="col-4 col-md">
                          ...
                          <!-- Heading -->
                          <div class="mb-5 font-weight-bold">Kids</div>
                          ...
                          <div class="card bg-cover" style="min-height: 330px;">
                            ...
                            <div class="card-body my-auto text-center">
                              <a class="stretched-link text-white" href="shop.html">
                                <h1 class="mb-1 font-weight-bolder text-uppercase">50% off</h1>
          ...
          <!-- Brand -->
          <a class="navbar-brand mx-auto d-none d-xl-block" href="overview.html">
            Shopper.
          </a>
            ...
            <div class="container d-flex flex-column">
              <div class="row align-items-center justify-content-end" style="min-height: 550px;">
                <div class="col-12 text-center text-white">
                  ...
                  <!-- Links -->
                  <p class="mb-0">
                    <a href="shop.html" class="link-underline text-reset mx-4 my-4">Shop Women</a>
                    <a href="shop.html" class="link-underline text-reset mx-4 my-4">Shop Men</a>
                  </p>
        ...
        <div class="row mx-n3">
          <div class="col-12 col-sm-4 d-flex flex-column px-3">
            ...
            <div class="card card-xl mb-3 mb-sm-0" style="min-height: 280px">
              ...
              <!-- Background -->
              <div class="card-bg">
                <div class="card-bg-img bg-cover" style="background-image: url(assets/img/products/product-22.jpg);"></div>
              </div>
          ...
          <div class="col-12 col-sm-4 d-flex flex-column px-3">
            ...
            <div class="card card-xl mb-3 mb-sm-0" style="min-height: 280px;">
              ...
              <!-- Background -->
              <div class="card-bg">
                <div class="card-bg-img bg-cover" style="background-image: url(assets/img/products/product-23.jpg);"></div>
              </div>
          ...
          <div class="col-12 col-sm-4 d-flex flex-column px-3">
            ...
            <div class="card card-xl bg-cover bg-hover" style="min-height: 280px;">
              ...
              <!-- Background -->
              <div class="card-bg">
                <div class="card-bg-img bg-cover" style="background-image: url(assets/img/products/product-24.jpg);"></div>
              </div>
                ...
                <div class="flickity-buttons-lg flickity-buttons-offset px-lg-12" data-flickity='{"prevNextButtons": true}'>
                  ...
                  <div class="col" style="max-width: 200px;">
                    <div class="card">
                      ...
                      <!-- Image -->
                      <img class="card-img-top" src="assets/img/products/product-125.jpg" alt="...">
                  ...
                  <div class="col" style="max-width: 200px;">
                    <div class="card">
                      ...
                      <!-- Image -->
                      <img class="card-img-top" src="assets/img/products/product-126.jpg" alt="...">
        ...
        <div class="row">
          <div class="col-12 col-md-6">
            ...
            <div class="card card-lg">
              ...
              <div class="card-circle card-circle-lg card-circle-right">
                <strong class="font-size-xs text-decoration-line-through opacity-80">$99.00</strong>
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="card card-lg">
              ...
              <!-- Image -->
              <img class="card-img-top" src="assets/img/products/product-31.jpg" alt="...">
        ...
        <div class="row position-relative align-items-center">
          <div class="col-md-7 col-lg-5 offset-lg-1">
            ...
            <div class="d-none d-md-block" data-flickity='{"fade": true, "asNavFor": "#sliderArrivals", "draggable": false}'>
              ...
              <!-- Item -->
              <div class="w-100">
                <img src="assets/img/products/product-34.jpg" alt="..." class="img-fluid">
              </div>

              <!-- Item -->
              <div class="w-100">
                <img src="assets/img/products/product-136.jpg" alt="..." class="img-fluid">
              </div>

              <!-- Item -->
              <div class="w-100">
                <img src="assets/img/products/product-138.jpg" alt="..." class="img-fluid">
              </div>
            ...
            <div class="position-static flickity-buttons-lg" id="sliderArrivals" data-flickity='{"pageDots": true, "prevNextButtons": true}'>
              ...
              <div class="col-12">
                ...
                <div class="card">
                  ...
                  <!-- Badge -->
                  <div class="badge badge-dark card-badge">
                  ...
                  <div class="card-img">
                    ...
                    <!-- Image -->
                    <img class="card-img-top" src="assets/img/products/product-35.jpg" alt="...">

                  </div>

                  <!-- Body -->
                  <div class="card-body font-weight-bold text-center">
                    <a class="font-size-lg text-body" href="product.html">Textured cotton Top</a>
                    <div>
                      <span class="text-gray-350 text-decoration-line-through">$90.00</span>
                      <span class="font-size-lg text-primary">$69.00</span>
                    </div>
                  </div>
              ...
              <div class="col-12">
                ...
                <div class="card">
                  ...
                  <div class="card-img">
                    ...
                    <!-- Image -->
                    <img class="card-img-top" src="assets/img/products/product-137.jpg" alt="...">

                  </div>

                  <!-- Body -->
                  <div class="card-body font-weight-bold text-center">
                    <a class="font-size-lg text-body" href="product.html">Animal crossbody Bag</a>
                    <div>
                      <span class="font-size-lg text-muted">$59.00</span>
                    </div>
                  </div>
              ...
              <div class="col-12">
                ...
                <div class="card">
                  ...
                  <div class="card-img">
                    ...
                    <!-- Image -->
                    <img class="card-img-top" src="assets/img/products/product-139.jpg" alt="...">

                  </div>

                  <!-- Body -->
                  <div class="card-body font-weight-bold text-center">
                    <a class="font-size-lg text-body" href="product.html">Jacket with Pockets</a>
                    <div>
                      <span class="font-size-lg text-muted">$70.00</span>
                    </div>
                  </div>
...
<!-- Mirrored from yevgenysim.github.io/shopper/index-classic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Jan 2021 07:28:57 GMT -->
</html>
