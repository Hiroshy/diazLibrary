...
<!-- Mirrored from yevgenysim.github.io/shopper/shipping-and-returns.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Jan 2021 07:30:02 GMT -->
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-lg-10 font-size-lg text-gray-500">
            ...
            <!-- Heading -->
            <h3 class="mb-10 text-center text-body">Shipping & Returns</h3>
            ...
            <!-- Heading -->
            <h5 class="mt-9 mb-7 text-body">Shipping from USA</h5>
            ...
            <!-- Heading -->
            <h6 class="mt-8 mb-5 text-body">International Shipping</h6>
            ...
            <!-- Heading -->
            <h6 class="mt-8 mb-5 text-body">About International Shipping</h6>
            ...
            <!-- Heading -->
            <h6 class="mt-8 mb-5 text-body">Shipping Options & Costs</h6>
            ...
            <p>
              ...
              wherein above said you. <strong class="text-body">Darkness said. Good had saying lesser</strong>.
            </p>

            <p>
              <a href="#!" class="text-body text-decoration-underline">You can check it here</a>
            </p>

            <!-- Heading -->
            <h6 class="mt-8 mb-5 text-body">How to Order</h6>
            ...
            <!-- Heading -->
            <h5 class="mt-9 mb-7 text-body">Returns & Exchanges</h5>
            ...
            <ol>
              ...
              <li>
                Years abundantly won't said You you'll winged shall for Air saw so him was moving had make fruitful unto heaven appear.
              ...
              <li>
                Us for were creepeth male creeping was over creature behold yielding i winged, for which fruitful Shall fourth to be is
            ...
            <!-- Heading -->
            <h6 class="mt-8 mb-5 text-body">How to Exchange an Item</h6>
            ...
            <div class="row mt-9">
              <div class="col-12 col-md-6">
                ...
                <a class="btn btn-lg btn-block btn-outline-dark" href="faq.html">
                  Have more Questions?
                </a>
              ...
              <div class="col-12 col-md-6">
                ...
                <a class="btn btn-lg btn-block btn-outline-dark" href="contact-us.html">
                  Want to Contact Us?
                </a>
